# Blinkit Retail Sales and Operations Analytics
...
- Which outlet sizes, locations, and formats are most efficient?
...
- Total revenue and item volume analysis
...
##💡 Key Insights
- A small number of categories contribute a disproportionate share of total revenue (Pareto effect).
- Medium-sized outlets outperform small and large outlets in revenue efficiency.
- Tier 3 locations show strong revenue contribution, indicating cost-efficient expansion opportunities.
...
- Use location-based performance insights to guide expansion into high-potential Tier 3 markets.
